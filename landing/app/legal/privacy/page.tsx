        ...
        <div className="legal-body">
          ...
          <LegalSection id="responsavel" n={1} title="Quem é o responsável">
            ...
            <p>
              ...
              direitos, o canal de atendimento ao titular é <Contact />.
            </p>
            <Callout>
              A empresa se enquadra como agente de tratamento de pequeno porte
              (Resolução CD/ANPD nº 2/2022) e mantém o canal acima como via de
              atendimento ao titular. Caso um encarregado seja formalmente
              indicado, o nome dele passará a constar nesta seção.
            </Callout>
          </LegalSection>
          ...
          <LegalSection id="principio" n={3} title="O princípio: a Corneta é local">
            ...
            <p>
              ...
              os seus relatórios. Não existe painel nosso onde esses dados
              apareçam, porque eles nunca chegam até nós.
            </p>
            <Callout>
          ...
          <LegalSection id="api" n={5} title="Dados na API de login">
            <p>
              ...
              login (OAuth) com cada plataforma. Duas das três plataformas
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      Encaminha para <code>id.kick.com</code> junto com o segredo
                      do cliente e devolve os tokens ao seu aplicativo.
                    </td>
                  </tr>
                  <tr>
                    <td>
          ...
          <LegalSection id="app" n={6} title="Dados no seu computador">
            ...
            <ul>
              ...
              <li>
                ...
                taxa de chat, alertas, momentos marcados — são gravados em arquivos
                locais.
              </li>
              <li>
            ...
            <p>
              Desinstalar o aplicativo, apagar o arquivo de configuração e remover as
              credenciais do cofre do sistema elimina esses dados. Como eles estão
              sob a sua guarda, essa exclusão não depende de nós.
            </p>
          </LegalSection>
          ...
          <LegalSection id="bases" n={7} title="Bases legais">
            ...
            <ul>
              ...
              <li>
                ...
                7º, II) — quando a guarda de registros de acesso for exigida por lei.
              </li>
            </ul>
          </LegalSection>

          <LegalSection id="terceiros" n={8} title="Terceiros e conexões do app">
            <p>
            ...
            <p>
              Do nosso lado, o único operador envolvido é o provedor de hospedagem do
              site e da API, já indicado acima.
            </p>
          </LegalSection>
          ...
          >
            <p>
              ...
              {LEGAL_HOST ? <strong>{LEGAL_HOST}</strong> : <Todo>provedor de hospedagem</Todo>}
              , empresa sediada nos Estados Unidos, que pode processar as requisições
              em servidores fora do Brasil. As plataformas de transmissão, os
              agregadores de alertas e os serviços de emote citados acima também
              operam no exterior.
            </p>
            <p>
              Ao usar esses recursos, os dados necessários para a comunicação transitam
              internacionalmente, conforme as políticas de cada serviço e o disposto nos
              arts. 33 e seguintes da LGPD. Nenhum conteúdo da sua transmissão passa por
              esses servidores: o vídeo sai da sua máquina direto para cada plataforma.
            </p>
          </LegalSection>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      Pelo prazo praticado pelo provedor de hospedagem e pelos prazos
                      legais aplicáveis.
                    </td>
                  </tr>
                  <tr>
          ...
          <LegalSection id="seguranca" n={11} title="Segurança">
            ...
            <p>
              Nenhum sistema é infalível. Se identificarmos um incidente de segurança
              com risco relevante, comunicaremos os titulares e a Autoridade Nacional
              de Proteção de Dados (ANPD) na forma da lei.
            </p>
            <Callout>
              Encontrou uma falha? Fale com a gente por <Contact /> antes de divulgar
              publicamente. A gente responde e credita quem reporta.
            </Callout>
          </LegalSection>

          <LegalSection id="direitos" n={12} title="Seus direitos">
            <p>
              A LGPD garante a você, entre outros, o direito de confirmar a existência
              de tratamento, acessar os dados, corrigir dados incompletos ou
              desatualizados, pedir anonimização, bloqueio ou eliminação de dados
            ...
            <p>
              ...
              responder no prazo legal. Como não mantemos cadastro, a maior parte dos
              dados que dizem respeito a você já está sob o seu controle direto — e
              vamos explicar isso caso o seu pedido se refira a algo que não temos.
            </p>
          </LegalSection>
          ...
          >
            <p>
              Ao usar chat e alertas, o seu computador recebe dados de outras pessoas:
              apelidos, mensagens, valores de doação, avisos de inscrição. Esses dados
              chegam das plataformas diretamente ao seu aplicativo e{" "}
              <strong>não passam por nós</strong>.
            </p>
            <p>
              Em relação a esse tratamento, quem decide o que fazer com esses dados é
              você — inclusive se eles vão aparecer no overlay dentro da sua
              transmissão. Recomendamos atenção ao exibir nome e valor de quem apoia,
              e cuidado com o compartilhamento de gravações e capturas de tela.
            </p>
          </LegalSection>

          <LegalSection id="criancas" n={14} title="Crianças e adolescentes">
            <p>
              A Corneta é uma ferramenta de produção para quem transmite ao vivo e não
              é direcionada a crianças. As plataformas de transmissão têm idade mínima
              própria, e o seu uso deve respeitá-la. Se você é adolescente, use o
              aplicativo com ciência e assistência de quem responde por você.
            </p>
          </LegalSection>
