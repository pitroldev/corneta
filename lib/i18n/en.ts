...
export const en: Dict = {
  // ---- benefits ----
  "benefits.chat.body": "Twitch, YouTube and Kick scroll together, in the order things happened, and you reply right from there. The sub alert drops into the same column, right above whatever got typed next.",
  ...
  "benefits.chat.note": "You can pop it out into its own window on your second monitor",
  ...
  "benefits.heading.subtitle": "No alt-tab to find out who's still live and who's talking to you.",
  "benefits.heading.title": "One screen — even when it all goes sideways.",
  "benefits.routes.body": "Every platform gets its own connection. When one is reconnecting, the rest keep going — and you see it on the panel, which platform and what time, instead of finding out from chat.",
  ...
  "benefits.routes.note": "You can pause one platform and leave the rest running",
  ...
  "chrome.llms.notis.1": "- It doesn't replace OBS: scenes, camera and audio stay in your capture program.",
  "chrome.llms.notis.2": "- It's not a cloud relay: no server of ours receives, stores or forwards video.",
  "chrome.llms.notis.3": "- It doesn't need a Corneta account — there's no sign-up and no login on the site.",
  "chrome.llms.notis.4": "- There's no macOS or Linux version so far, and no public date for one.",
  "chrome.llms.platforms.body": "Ready to go in the app: Twitch, YouTube, Kick, Facebook and any custom RTMP or\nRTMPS server. Experimental, because they depend on the platform itself letting\nyou in: TikTok, Instagram and X. So far, Twitch is the one platform with a\ndocumented end-to-end stream.",
  // Troquei "controle" (substantivo abstrato proibido) por onde a coisa roda de verdade.
  "chrome.manifest.description": "Local multistream for streamers — one output per platform, all running on your PC.",
  ...
  "chrome.meta.description": "Multistream from your PC to Twitch, YouTube, Kick and more — chat in one place, your stream still up when the signal drops, and a report on what choked. Free.",
  ...
  "chrome.meta.title.default": "Corneta — multistream: one stream, many communities",
  // A quebra de linha no pt é do JSX, não do texto.
  "chrome.notfound.body": "The main stream is still up. Head back home and try another way.",
  ...
  "chrome.og.description": "Multistream that runs on your PC: each platform on its own connection, chat in one place, and a report on what choked during your stream. Free for Windows.",
  ...
  "chrome.twitter.description": "One stream, several platforms at once — and an app that keeps it up when the signal drops, then tells you what happened.",
  "chrome.twitter.title": "Corneta — one stream, many communities",

  // ---- closing ----
  "closing.cta.note": "Windows 10/11 · no sign-up · no subscription",
  "closing.cta.title": "Your next stream could already be in three places at once.",
  ...
  "closing.footer.tagline": "Multistream that runs on your PC — not in somebody else's cloud.",
  ...
  "closing.tiny.title": "The kind of thing you only notice on your third stream.",

  // ---- content ----
  "content.faq.free.answer": "It's free, no sign-up and no trial period. Everything that runs on your PC — multistream, chat, alerts, reports and protections — is open source under the MIT license and stays that way. If something paid ever shows up, it'll be an optional cloud service, and you'll know about it before you install anything.",
  "content.faq.free.question": "Is it really free? Will it turn into a subscription later?",
  "content.faq.macos_linux.answer": "Today the download is Windows only. It's built so other systems can come later, but there's no date to announce. If you're on macOS or Linux, the answer is: not yet.",
  "content.faq.macos_linux.question": "Does it work on macOS or Linux?",
  "content.faq.multistream_ban.answer": "Each platform decides that, not Corneta — and those rules have changed a lot in the last few years: several of them allow it now, with conditions that depend on your account type or on a contract you signed. Corneta doesn't change any of that, it just sends your signal where you tell it to. Before you go live in two places at once, read the terms of whoever you already signed with. Five minutes now saves you a headache later.",
  "content.faq.multistream_ban.question": "Can I stream to Twitch and YouTube at the same time? Won't I get banned?",
  "content.faq.obs_plugin.answer": "If all you want is to send the same video to more than one place, the plugin does the job — and we'd rather tell you that now than after the download. Corneta earns its place when the stream is more than just pushing video out: it holds the stream up when your program crashes (the plugin goes down with it, because it lives inside OBS), puts chat and alerts from every platform in one place, warns you if something private of yours shows up on screen and, at the end, builds a report that cross-checks your machine, your OBS and each platform to say why it stuttered.",
  "content.faq.obs_plugin.question": "I already use a multistream plugin in OBS. Why switch?",
  "content.faq.overlay.answer": "There is. Corneta runs a small server on your own PC that serves the alerts and the chat (emotes included) at a URL you add as a Browser Source — just once. Position, size, duration, sound and message limit are all adjustable, and there's a test alert button so you can check it right there.",
  "content.faq.overlay.question": "Is there an overlay I can use in OBS?",
  "content.faq.performance.answer": "Depends on the mode. Copying the signal from your program costs almost nothing — a modest PC handles it. Reworking the image for each platform puts the job on the graphics card (recent NVIDIA, Intel and AMD ones handle it fine) or, if you don't have one, on the processor, which hits a lot harder. Before you go live, Corneta estimates that load and how many conversions your card can take.",
  "content.faq.performance.question": "Will it lag my game? Do I need a good graphics card?",
  "content.faq.platforms.answer": "Twitch, YouTube, Kick, Facebook and any RTMP server you want to add. TikTok, Instagram and X show up as experimental because they depend on approval and on each platform's own way in.",
  "content.faq.platforms.question": "Which platforms show up in the app?",
  "content.faq.replaces_obs.answer": "No. You keep building scenes, camera and audio in the program you already use. Corneta picks up from there: it takes that signal, pushes it to the platforms, watches how each one is holding up, and keeps the stream's safety nets running.",
  ...
  "content.faq.streamlabs_xsplit.answer": "It works. Corneta takes any program that streams over RTMP — just point it at the address the app shows you, same as you'd do with a platform. With OBS you get one extra shortcut: Corneta sets it up for you, and hits play when you press BORA AO VIVO.",
  "content.faq.streamlabs_xsplit.question": "I use Streamlabs (or XSplit). Does it work?",
  "content.faq.upload.answer": "Each platform eats a slice of your upload. Before the stream, Corneta measures your connection, adds it all up and helps you pick a setup that fits with room to spare.",
  "content.faq.upload.question": "Am I going to need a lot of internet?",
  "content.faq.vertical_tiktok.answer": "Corneta crops a 9:16 out of your landscape video and you pick the framing, with a preview before it goes out. TikTok and Instagram are still experimental because getting in depends on the platform approving you; the same crop works for any vertical RTMP destination.",
  "content.faq.vertical_tiktok.question": "Can I send vertical video to TikTok?",
  "content.features.alerts": "Alerts from the platforms and from Streamlabs/StreamElements in the same panel",
  "content.features.auto_bitrate": "Auto-bitrate when your internet starts choking, plus an optional audio normalizer",
  ...
  "content.features.brb_screen": "JÁ VOLTO (\"BE RIGHT BACK\") screen that holds the stream up when the program's signal drops",
  "content.features.independent_connections": "Each platform on its own connection: if one drops, the others stay on air",
  "content.features.keys_in_vault": "Stream keys kept in Windows Credential Manager",
  "content.features.load_estimate": "Estimate of your total upload and of the load on your graphics card before you go live",
  "content.features.multistream": "Multistream from a single signal to Twitch, YouTube, Kick, Facebook and any RTMP server",
  "content.features.overlay": "Alert and chat overlay for OBS, served from your own machine as a Browser Source",
  "content.features.post_live_report": "Post-stream report that points at the likely cause of each stutter — encoding, internet or platform — with the minute to find it in the VOD",
  "content.features.privacy_guard": "Privacy guard: reads what's going out on air and cuts to JÁ VOLTO if something private of yours shows up on screen",
  "content.features.quality_modes": "Three quality modes — copy the signal, convert only what needs it, or convert everything",
  "content.features.report_per_channel": "Viewers, chat and alerts in the report broken down by channel, with export to HTML, CSV and JSON",
  "content.features.unified_chat": "One chat for Twitch, Kick and YouTube, with emotes — you reply and moderate right there",
  "content.features.vertical_crop": "Vertical 9:16 crop with manual framing for TikTok and Instagram",
  ...
  "content.one_liner": "Corneta is a free, open source Windows app that takes a single video signal from OBS (or from any program that streams over RTMP) and sends it at the same time to Twitch, YouTube, Kick, Facebook and other destinations, each platform on its own connection. Beyond just sending the video, it handles the whole stream: it gathers chat and alerts from every platform, keeps the stream up when the program's signal drops, and builds a post-stream report that cross-checks the machine, OBS and the platforms to point at the likely cause of each instability — all of it processed on the streamer's own computer.",
  "content.scopes.kick.never": "This is the only login that goes through our server, because Kick requires a server-side secret in the exchange — and even then the token is not stored anywhere.",
  "content.scopes.kick.permission": "Read the channel, send chat, and moderate",
  "content.scopes.kick.title": "Kick account",
  "content.scopes.kick.why": "The same things as the unified chat: read, reply and moderate without leaving the app.",
  "content.scopes.twitch.never": "Nothing is posted to your channel unless you ask for it, and Corneta does not follow, subscribe or change anything in your account.",
  "content.scopes.twitch.permission": "Read and send chat, moderate, and manage the stream",
  "content.scopes.twitch.title": "Twitch account",
  "content.scopes.twitch.why": "Show the chat in the app, reply from there, delete a message or time someone out when you say so, and follow the state of your stream.",
  "content.scopes.youtube.never": "Corneta does not upload recorded video to your channel, does not touch the videos already there, does not read your history, and does not use this data for advertising or model training.",
  ...
  "content.scopes.youtube.why": "Create the live broadcast and get its stream key automatically, give it the title you wrote in the app, end it when the stream is over, read and send messages in the live chat, and show how many people are watching.",
  "content.steps.1.text": "Corneta opens the right page on each platform for you to copy the key, and keeps it in Windows Credential Manager — never in a config file.",
  "content.steps.1.title": "Pick where you want to show up",
  "content.steps.2.text": "With OBS, Corneta sets it up by itself. With anything else (Streamlabs, XSplit), you paste one address and one key — once, and never again.",
  "content.steps.2.title": "Hook up your streaming program",
  "content.steps.3.text": "The panel shows each platform coming on air, one by one, and you go back to the game. If you want, Corneta tells OBS to start along with it.",
  ...
  // ---- hero ----
  "hero.cta.footnote": "Corneta for Windows 10/11 · no sign-up · no subscription",
  ...
  "hero.mechanism.step3.detail": "your keys, your settings and the report from every stream",
  ...
  "page-data.destinations.instagram.note": "Vertical video — no official way in, so it can drop",
  ...
  "page-data.destinations.tiktok.note": "Vertical video — your account has to be approved",
  ...
  "page-data.tiny.backup.text": "Exports your setup to a file. The keys stay in Windows Credential Manager and don't go with it.",
  "page-data.tiny.backup.title": "Settings backup",
  "page-data.tiny.chatwindow.text": "Chat, alerts, or both in a window that sits on top of everything, at whatever size you want.",
  "page-data.tiny.chatwindow.title": "Little chat window",
  "page-data.tiny.hotkey.text": "Start and cut the stream without leaving the game — the key works even when Corneta's in the background.",
  ...
  "page-data.tiny.profiles.text": "Platform and quality presets, ready to go: your usual stream, the one with a guest, the test one.",
  "page-data.tiny.profiles.title": "Saved profiles",
  "page-data.tiny.startup.text": "Boots up with the PC, ready to stream — if you want it to.",
  ...
  "page-data.tiny.theme.text": "The same poster in the dark or on paper — and flipping it blows the horn.",
  "page-data.tiny.theme.title": "Light and dark theme",
  "page-data.tiny.tray.text": "Closing the window hides Corneta next to the clock — the stream stays up.",
  ...
  "page-data.tiny.youtube.text": "With your account connected, Corneta creates the broadcast and drops the key into BORA AO VIVO. You never open YouTube Studio.",
  ...
  "protection.alerts.item.raid.meta": "Twitch · brought new people into the chat",
  ...
  "protection.alerts.item.sub.meta": "Twitch · tier 1 · “been here since day one!”",
  ...
  "protection.alerts.item.superchat.meta": "YouTube · “walk us through your setup!”",
  "protection.alerts.item.superchat.title": "Superchat from Marcos L.",
  "protection.alerts.note": "Follows, subs, resubs, subgifts, bits, raids, members and superchats come straight from the platforms. Donations and goals come in through Streamlabs or StreamElements, with the token kept in Windows Credential Manager. The panel sits next to the chat — or in its own little window, on top of the game.",
  "protection.body": "Four nets you turn on (or don't) in Settings. Each one costs you something — and Corneta tells you what it costs before you go live, not in the middle of it.",
  ...
  "protection.brb.body": "If OBS drops mid-stream, this screen goes on air without dropping the platforms — from the viewer's side the stream doesn't even blink, and it comes back on its own when the signal returns. It also works for a manual break: one click and you're out of the chair with the mic muted.",
  ...
  "protection.brb.title": "“JÁ VOLTO” (“BE RIGHT BACK”): the signal drops, the stream keeps going",
  "protection.chat.body": "Read, reply and moderate without switching windows. Alerts from the platforms and from Streamlabs in the same panel. And an overlay you paste into OBS once and forget.",
  ...
  "protection.chat.note": "Twitch, Kick and YouTube in the same feed — up to two Twitch channels at once. BTTV, FFZ and 7TV emotes, badges, timestamps and one field to send from. Delete and time out right in the feed: the message turns into a tombstone instead of vanishing with no explanation and leaving you in the dark.",
  ...
  "protection.chat.title": "Nobody's left talking to themselves in a tab you never opened.",
  "protection.guard.audio.body": "Corneta evens out your audio before it goes out — no “can't hear you” from chat, no blown-out ears when you switch scenes, in the same encode that was already running.",
  "protection.guard.audio.cost": "If you already normalize in OBS, leave this off so the two don't fight.",
  "protection.guard.audio.switch": "optional",
  "protection.guard.audio.title": "Audio normalizer",
  "protection.guard.bitrate.body": "If your internet chokes, Corneta drops the video quality for a while instead of letting the stream stutter or die — and brings it back up on its own.",
  "protection.guard.bitrate.cost": "Only works on the platforms being re-encoded; the ones getting a straight copy go out exactly the way OBS sent them.",
  "protection.guard.bitrate.switch": "on by default",
  "protection.guard.bitrate.title": "Auto-bitrate",
  "protection.guard.privacy.body": "You list the words that can't leak — email, real name, address. If one of them shows up on screen, Corneta cuts to JÁ VOLTO before it goes on air.",
  "protection.guard.privacy.cost": "Costs 12s of delay on the whole stream (the chat too). Safety net, not a guarantee.",
  ...
  "protection.overlay.note": "A local server puts the alerts and the chat (emotes and all) on a URL you add as a Browser Source — once, and Corneta can even create the source in OBS for you. Position, size, duration, sound, how many messages stay on screen and hiding commands (“!”) are all adjustable. There's a test alert button so you can check it without waiting for anyone.",
  ...
  "quality.heading.body": "Your stream can go out looking great on every platform without frying your PC — but that's a choice, and it costs you upload and GPU. You see that bill before you go live, not halfway through it. Here's what changes in each mode:",
  "quality.heading.kicker": "How good it looks on each platform",
  "quality.heading.title": "The same picture for every platform, or one sized for each.",
  // "gravação" vira "the VOD": é o nome que o streamer usa em inglês e é coisa que existe na tela.
  "quality.journey.after.body": "It's not a pile of loose numbers: Corneta cross-checks what your machine, your OBS and each platform did, then points at the likely cause of every stutter — with the minute to jump to in the VOD and what to change so it doesn't happen again.",
  "quality.journey.after.sticker": "After the stream",
  "quality.journey.after.title": "Find out why it stuttered — and what to change.",
  "quality.journey.before.body": "Hook up the platforms, measure your upload and get everything ready in a few clicks. Corneta sets OBS up for you — and hits play on it when you press BORA.",
  ...
  "quality.journey.before.stat.caption": "enough for three platforms, with room to spare",
  ...
  "quality.journey.before.title": "Get to BORA AO VIVO (\"GO LIVE\") without that pit in your stomach.",
  "quality.journey.during.body": "Bitrate, fps, dropped frames and time on air for each platform, plus real CPU and GPU load. You can pause one without ending the others — and whichever one drops comes back on its own.",
  "quality.journey.during.sticker": "During the stream",
  "quality.journey.during.title": "One glance out of the corner of your eye and back to the game.",
  ...
  "quality.mode.caprichado.lead": "Best picture each platform can take, but it's the heaviest.",
  ...
  "quality.mode.caprichado.verdict": "YouTube gets all 9000 kbps it can take and every platform gets the best picture it can show — but your upload and your GPU pay for it. You see that total before you hit BORA.",
  "quality.mode.esperto.encodes": "1 (on the GPU)",
  "quality.mode.esperto.lead": "Only touches the platforms that need it. Figures it out on its own.",
  ...
  "quality.mode.esperto.verdict": "One conversion, just for the vertical feed. The rest goes out as a copy: your machine barely feels it and nobody loses quality along the way.",
  "quality.mode.lata.encodes": "none",
  "quality.mode.lata.lead": "The same picture goes to every platform, at the same settings.",
  ...
  "quality.mode.lata.verdict": "TikTok is the weakest one on the list, so everybody drops to its bitrate — and it still gets landscape video. Corneta shows you that damage before you go live, with the fix one click away.",
  "quality.vertical.body": "TikTok and Instagram only take vertical video. Instead of building a second scene and streaming twice, Corneta crops a 9:16 out of what's already on air — and you pick the framing by dragging the box, watching it as you go.",
  ...
  "quality.vertical.note": "TikTok and Instagram are still experimental: getting in depends on the platform clearing you first.",
  ...
  "steps.accounts.lede": "You can just paste your stream key and be done. But connect your account and the app does the boring part for you: creates the stream, grabs the key and pulls the chat in. Here's exactly what each permission is for.",
  "steps.accounts.privacy.link": "privacy policy",
  "steps.accounts.privacy.text": "Access tokens sit in Windows Credential Manager, on your machine — not on our servers, because there's no Corneta account and no database with your name in it. You can revoke access any time on the platform itself, and uninstalling the app wipes what it put there. The details are in the",
  ...
  "steps.local.body": "The heavy lifting happens on the machine that's already streaming. Settings, keys and reports stay with you — and even the OBS overlay is a server that only answers inside your own computer.",
  ...
  "steps.local.honest.body": "And bumping the quality for each one hits your graphics card or your CPU. Corneta measures your connection, adds it all up and shows you the math before you go live — not halfway through it.",
  ...
  "steps.local.proof.text": "Open source: you can open the repo and see exactly what the app does with your key.",
  "steps.local.title": "No monthly fee, because there's no Corneta server in the middle.",
  "steps.platforms.kicker": "From your channel to everywhere",
  "steps.platforms.lede": "The big four come ready, with each one's address already filled in. Add as many as you want — including any RTMP server that isn't on this list.",
  "steps.platforms.note.experimental.strong": "TikTok, Instagram and X are experimental.",
  "steps.platforms.note.experimental.text": "Whether you get in depends on each platform's approval and its own sign-up flow, so they might just not work for your account.",
  "steps.platforms.note.validation": "So far, Twitch is the only platform where we've documented a real stream end to end. The others are built into the app and still being tested in the open.",
