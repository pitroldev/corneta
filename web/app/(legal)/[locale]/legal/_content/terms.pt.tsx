...
export const termsHeroPt = {
  kicker: "Termos de uso",
  title: "As regras do jogo, em português de gente.",
  intro:
    "A Corneta é software livre que roda na sua máquina. Estes termos dizem o que você pode fazer com ela, o que é responsabilidade sua ao transmitir, e até onde vai a nossa — sem letrinha miúda.",
};

export const termsSectionsPt = [
    ...
    <>
      <LegalSection id="aceitacao" n={1} title="Aceitação destes termos">
        <p>
          ...
          <strong>{LEGAL_CNPJ}</strong>. Se não concordar com eles, não instale
          o aplicativo — e, se já tiver instalado, desinstale.
        </p>
        <p>
          Você aceita estes termos ao concluir ou dispensar a tela de
          boas-vindas do aplicativo, onde este documento e a Política de
          Privacidade aparecem como links antes de qualquer uso. O instalador
          também exibe as duas referências, e elas ficam permanentemente
          acessíveis na tela <strong>Sobre</strong>. O registro de que você
          passou por esse aviso fica apenas no seu computador: não existe
          cadastro, conta ou servidor nosso guardando esse dado.
        </p>
        <p>
          Se você usa a Corneta em nome de uma empresa, canal ou equipe, declara
          ter poderes para aceitar estes termos em nome dela. Sendo menor de 18
          anos, use o aplicativo com a assistência de quem responde legalmente
          por você.
        </p>
      </LegalSection>
      ...
      <LegalSection id="licenca" n={3} title="Licença de uso do software">
        <p>
          ...
          sublicenciar e vender cópias do software, desde que o aviso de
          direitos autorais e o aviso de permissão sejam preservados.
        </p>
        <p>
          Em caso de divergência entre estes termos e a licença MIT no que se
          refere ao <em>código</em>, prevalece a licença MIT. Estes termos
          tratam do uso do aplicativo distribuído, do site e do serviço de
          login.
        </p>
      </LegalSection>
      ...
      <LegalSection id="terceiros" n={4} title="Componentes de terceiros">
        <p>
          ...
          <strong>FFmpeg</strong> (build sob GPL) e o <strong>MediaMTX</strong>.
          A licença MIT do nosso código não substitui essas obrigações.
        </p>
        <p>
      ...
      <LegalSection id="login" n={5} title="Serviço de login">
        <p>
          ...
          mínimo hospedado neste domínio, que conclui a troca de credenciais com
          a plataforma. Esse serviço é oferecido gratuitamente, no estado em que
          se encontra, sem compromisso de disponibilidade, tempo de resposta ou
          continuidade.
        </p>
        <ul>
          <li>
      ...
      <LegalSection id="responsabilidades" n={6} title="Suas responsabilidades">
        ...
        <ul>
          <li>
            ...
            música, jogos, marcas e qualquer conteúdo de terceiros que apareça
            na sua live.
          </li>
          <li>
            <strong>Não usar o aplicativo para conteúdo ilícito</strong>, para
            violar direitos de outra pessoa ou para transmitir a partir de
      ...
      <LegalSection id="plataformas" n={7} title="Regras das plataformas">
        <p>
          ...
          plataformas e restringido por outras, e essas regras mudam com o
          tempo, às vezes de acordo com o seu tipo de conta ou contrato de
          exclusividade.
        </p>
        <Callout>
        ...
        <p>
          A Corneta não fiscaliza, não interpreta e não garante a conformidade
          do seu uso com as regras de terceiros. Também não temos como
          restabelecer contas suspensas por eles.
        </p>
      </LegalSection>
      ...
      <LegalSection id="experimental" n={8} title="Recursos experimentais">
        <p>
          ...
          <strong>experimentais</strong> justamente porque dependem de terceiros
          ou ainda não têm validação ampla. Eles podem falhar, mudar de
          comportamento ou ser removidos:
        </p>
        <ul>
          <li>
            <strong>TikTok, Instagram e X</strong> dependem de liberação e de
            fluxos das próprias plataformas, que podem não estar disponíveis
            para a sua conta.
          </li>
          <li>
          ...
          <li>
            ...
            auto-bitrate reagem a condições detectáveis; falhas fora do previsto
            podem, ainda assim, interromper a sua live.
          </li>
        </ul>
        <p>
      ...
      >
        <p>
          ...
          danos indiretos, lucros cessantes, perda de audiência, perda de
          receita de inscrições ou doações, perda de dados, suspensão de contas
          em plataformas ou interrupção de transmissão decorrentes do uso ou da
          impossibilidade de uso do software.
        </p>
        <Callout>
          Esta limitação não afasta direitos que a lei não permite afastar. Se
          você usa a Corneta como consumidor, o Código de Defesa do Consumidor
          continua aplicável, assim como as hipóteses legais de dolo e culpa
          grave.
        </Callout>
      </LegalSection>
      ...
      <LegalSection id="marcas" n={12} title="Marcas e não afiliação">
        <p>
          ...
          Streamlabs, StreamElements e demais nomes citados são marcas dos seus
          respectivos titulares, usados aqui apenas para identificar
        ...
        <p>
          ...
          projeto são de {LEGAL_OPERATOR}. A licença MIT cobre o código, não a
          marca: se você distribuir uma versão modificada, não a apresente como
          se fosse a Corneta oficial.
        </p>
      </LegalSection>
      ...
      >
        <p>
          ...
          acompanhar essas mudanças; a data de revisão no topo indica a versão
          vigente, hoje de {LEGAL_UPDATED_LABEL_PT}.
        </p>
        <p>
          Correções de redação valem a partir da publicação. Já uma mudança{" "}
          <strong>material</strong> — passar a cobrar por algo hoje gratuito,
          pedir uma permissão nova nas suas contas ou restringir o serviço de
          login — faz o aplicativo avisar você de novo, com estes documentos à
          mão, antes de continuar. Seguir usando depois desse aviso significa
          concordar com a versão publicada.
        </p>
      </LegalSection>
      ...
      <LegalSection id="encerramento" n={14} title="Encerramento">
        <p>
          ...
          descontinuar o site ou o serviço. Os direitos concedidos pela licença
          MIT sobre as versões que você já possui permanecem.
        </p>
      </LegalSection>
      ...
      <LegalSection id="lei" n={15} title="Lei aplicável e foro">
        <p>
          ...
          {LEGAL_VENUE ? (
            ...
            <Todo locale={L}>comarca do foro</Todo>
          )}
      ...
      <LegalSection id="contato" n={16} title="Contato">
        <p>
          ...
          fale com a gente por <Contact locale={L} />. Para assuntos de dados
          pessoais, veja a{" "}
          <Link href={LEGAL_ROUTES.privacy}>Política de privacidade</Link>.
        </p>
      </LegalSection>
