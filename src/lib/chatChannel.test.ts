...
const cases: [Parameters<typeof normalizeChatChannel>[0], string, string][] = [
  ...
  ["youtube", "youtube.com/channel/UC1234567890123456789012/live", "UC1234567890123456789012"],
  ["youtube", "youtube.com/c/SomeName", "youtube.com/c/SomeName"],
  ["youtube", "https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=PLx", "dQw4w9WgXcQ"],
  ["youtube", "https://youtu.be/dQw4w9WgXcQ?si=x", "dQw4w9WgXcQ"],
  ["youtube", "https://studio.youtube.com/video/dQw4w9WgXcQ/livestreaming", "dQw4w9WgXcQ"],
  ["youtube", "https://www.youtube.com/embed/live_stream?channel=UCabcdefghijklmnopqrstuv", "UCabcdefghijklmnopqrstuv"],
