  ...
  return (
    <div className={cn("flex items-center gap-2.5", className)}>
      <input
        ...
        className={cn(
          "h-1.5 flex-1 cursor-pointer appearance-none rounded-full bg-surface-3 outline-none",
      ...
      />
      {suffix != null && (
        <span className="w-10 shrink-0 text-right text-xs font-bold tabular-nums text-ink-muted">
          {value}
          {suffix}
        </span>
      )}
